...
<asp:Content ID="Content1" ContentPlaceHolderID="Noi_dung" runat="server">
    ...
    <div class="row" style="padding-bottom: 10px">
        ...
        Dia chi: <asp:TextBox ID="txtdiachi" runat="server"></asp:TextBox>
        So Dien thoai: <asp:TextBox ID="txtsodt" runat="server"></asp:TextBox>
        <div class="col-md-12">
            <asp:Button ID="btdathang" CssClass="btn btn-success" runat="server" Text="Đặt hàng" OnClick="btdathang_Click" />
        </div>
    </div>
